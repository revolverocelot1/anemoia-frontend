        ...
        {mode === 'demo' ? (
          <div className="space-y-4">
            <p className="text-gray-300 text-sm">
              Click the button below to instantly access all features with a demo account. 
              No registration required!
            </p>
            <motion.button
              onClick={handleDemoLogin}
              disabled={isLoading !== null}
              className="w-full px-6 py-3 bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-500 hover:to-cyan-500 text-white font-medium rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
