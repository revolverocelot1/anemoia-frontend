        ...
        <div className="flex items-center justify-between h-16">
          ...
          {isAuthenticated ? (
              ...
              >
                ...
                {/* User Info */}
                <div className="flex items-center space-x-3">
              <div className="w-8 h-8 rounded-full ring-2 ring-gray-600 hover:ring-blue-400 transition-all duration-300 bg-gradient-to-r from-cyan-500 to-blue-500 flex items-center justify-center text-white font-bold text-sm">
