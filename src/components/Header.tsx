...
const Header = () => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#223649] px-10 py-4 shadow-md bg-[#101a23]/80 backdrop-blur-md max-w-screen-xl mx-auto">
